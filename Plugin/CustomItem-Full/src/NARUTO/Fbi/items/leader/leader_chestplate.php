...
class leader_chestplate extends Armor implements ItemComponents {
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier) {
        $name = "FBI Leader Chestplate";
        ...
        $this->initComponent('mazario_moa:ender_dragon_chestplate', $inventory);
