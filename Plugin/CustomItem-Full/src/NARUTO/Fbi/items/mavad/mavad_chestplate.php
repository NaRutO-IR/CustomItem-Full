...
class mavad_chestplate extends Armor implements ItemComponents {
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier) {
        $name = "FBI Mobarez Mavad Chestplate";
        ...
        $this->initComponent('mazario_moa:creeper_chestplate', $inventory);
