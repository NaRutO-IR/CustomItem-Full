...
namespace NARUTO\Army\items\sarbaz;
...
class sarbaz_chestplate extends Armor implements ItemComponents {
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier) {
        $name = "Sarbaz Chestplate";
        ...
        $this->initComponent('mazario_moa:panda_chestplate', $inventory);
